...
const s = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', gap: 14, padding: 18, borderRadius: 18, borderWidth: 1.5, borderColor: BRAND.primaryLight, backgroundColor: 'rgba(255,255,255,0.82)', marginBottom: 14 },
  cardRep: { borderColor: '#FFD0E4' },
  cardIcon: { width: 58, height: 58, borderRadius: 29, alignItems: 'center', justifyContent: 'center' },
  cardInfo: { flex: 1 },
  cardTitle: { fontSize: 16, fontWeight: '800', color: BRAND.primary },
  cardTitleKn: { fontSize: 12, color: '#888', marginBottom: 2 },
  cardDesc: { fontSize: 12, color: '#666' },
  flag: { fontSize: 36 },
  districtBtn: { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1.5, borderColor: BRAND.primary, borderRadius: 14, paddingHorizontal: 18, paddingVertical: 16, backgroundColor: 'rgba(255,255,255,0.82)', marginBottom: 14 },
  districtBtnText: { flex: 1, fontSize: 15, fontWeight: '700', color: BRAND.primary },
  infoBox: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: BRAND.primarySoft, borderRadius: 10, padding: 12, marginBottom: 24 },
  infoText: { flex: 1, fontSize: 12, color: BRAND.primary, lineHeight: 18 },
  startBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: BRAND.primary, borderRadius: 16, paddingVertical: 17 },
  startBtnDisabled: { backgroundColor: BRAND.primaryLight },
  startBtnText: { color: '#fff', fontSize: 16, fontWeight: '800' },
  // Policy step
  policyBox: { backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: 14, padding: 16, borderWidth: 1.5, borderColor: BRAND.primaryLight, marginBottom: 18 },
  policyIconRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  policyBoxTitle: { fontSize: 14, fontWeight: '800', color: BRAND.primary },
  policyText: { fontSize: 13, color: '#444', lineHeight: 20 },
  checkRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, marginBottom: 24, backgroundColor: 'rgba(255,255,255,0.7)', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: BRAND.primaryLight },
  checkbox: { width: 22, height: 22, borderRadius: 6, borderWidth: 2, borderColor: BRAND.primary, alignItems: 'center', justifyContent: 'center', marginTop: 1, flexShrink: 0 },
